...
if(isset($_POST['uploadbt'])){
    ...
    $year= date("Y", strtotime($_POST['year1']));
    $date=$year;
    if($date!=""){
    $orgDate=$year;
    $newDate = date("Y", strtotime($orgDate));
    $path="../member/".$newDate;
    if(!is_dir($path)){
    ...
    for($i=0;$i<$countfiles;$i++){
        ...
        // Upload file
        move_uploaded_file($_FILES['file']['tmp_name'][$i],"../member/".$newDate."/".$filename);
...
if(isset($_POST['SubmitButton'])){
    ...
    $c=0;
    for($x=0;$x<sizeof($getsheet);$x++){
    $email=strtolower($getsheet[$x][1]."@charusat.edu.in");
    $chash=$getsheet[$x][3];
   
    $sql1="INSERT into mem_cert (Email,Chash,Year) values('".$email."','".$chash."','".$year."')";
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    ...
                    <form action="./member.php" method="post" enctype="multipart/form-data">
                    <div class="form-group row">
                        <label for="ename" class="col-sm-2 col-form-label">Year:</label>
                        <div class="col-sm-5">
            ...
            <div class="card mb-4">
                        ...
                        <div class="form-group row">
                        <label for="pdf"  class="col-sm-2 col-form-label">Year:</label>
                        <div class="col-sm-5">
                        
                             <input type="month" class="form-control" id="year1" name="year1">
                            </div>
                        </div>
                        <div class="form-group row">
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Copyright &copy; Egaer Beavers Club</div>
                        <div>
