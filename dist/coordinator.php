        ...
        if (isset($_FILES['file'])) {
            ...
            if ($date!="") {
                ...
                for ($i=0;$i<$countfiles;$i++) {
                    ...
                    // Upload file
                    move_uploaded_file($_FILES['file']['tmp_name'][$i], "../coordinator/".$newDate."/".$filename);
                }
                header("Refresh:0");
            } else {
    ...
    if (isset($_POST['SubmitButton'])) {
        if (isset($_FILES['filepath'])) {
            ...
            for ($x=1;$x<sizeof($getsheet);$x++) {
                ...
                $sql1="INSERT into `cord_cert` (EName,Date,Chash,email) values('".$ename."','".$date."','".$chash."','".$email."')";
            ...
            <main>
                <div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                        <form action="./coordinator.php" method="post" enctype="multipart/form-data">
